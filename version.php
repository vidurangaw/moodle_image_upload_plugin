...
$plugin->version   = 2014031500;        // The current plugin version (Date: YYYYMMDDXX)
$plugin->requires  = 2014111000;        // Requires this Moodle version
$plugin->component = 'repository_image_upload'; // Full name of the plugin (used for diagnostics)
